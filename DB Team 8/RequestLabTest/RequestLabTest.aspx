<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequestLabTest.aspx.cs" Inherits="DB_Team_8.RequestLabTest.RequestLabTest" %>
...
<head runat="server">
    <title></title>
    <link rel="stylesheet" type="text/css" href="/RequestLabTest/Req.css">
</head>
<body>
...
<div class="sidenav">
    ...
    <div class="url">
        <a href="/RequestLabTest/RequestLabTest.aspx" class="active">Request LabTest</a>
        <hr align="center">
    </div>
    <div class="url">
   ...
   <div class="main">
            ...
            <div class="card">
                <div class="card-body">
                    <div>
                         <asp:Label ID="Label1" runat="server" Text="Insert Patient ID:"></asp:Label>
                    </div>
                    <div>
                        <asp:TextBox ID="patientID" runat="server" />
                    </div>
                    <div>
                        <asp:Label ID="Label3" runat="server" Text="Insert Lab ID:"></asp:Label>
                    </div>
                    <div>
                        <asp:TextBox ID="labTestID" runat="server" />
                    </div>
                    <div>
