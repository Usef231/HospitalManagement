<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List_all_Pres.aspx.cs" Inherits="Lilo.List_all_Pres" %>
...
<div class="sidenav">
    ...
    <div class="sidenav-url">
        ...
        <hr align="center">
         ...
         <div class="url">
         <a href="List_all_Pres.aspx" title="List the Prescriptions written by each doctor to each patient" class="active">List All Prescriptions</a>
         <hr align="center">
         </div>
...
<div class="main">
   <div class="card">
    <div class="card-body">
        <div>
        <asp:GridView ID="gridViewPrescriptions" runat="server" AutoGenerateColumns="True"></asp:GridView>
            </div>
        <div>
