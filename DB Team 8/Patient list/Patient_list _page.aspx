<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Patient_list _page.aspx.cs" Inherits="DB_Team_8.Patient_list_page.WebForm1" %>
...
<body>
    ...
    <div class="sidenav">
        ...
        <div class="sidenav-url">
            <div class="url">
                <a href="/Patient list/Patient_list _page.aspx" class="active">Patient List</a>
                <hr align="center">
            </div>
            <div class="url">
    ...
    <div class="main">
        ...
        <div class="card">
            <div class="card-body">
            <asp:GridView ID="GridViewPatientList" runat="server" AutoGenerateColumns="True">
            </asp:GridView>
